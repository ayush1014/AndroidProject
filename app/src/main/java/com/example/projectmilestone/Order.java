...
public class Order extends AppCompatActivity {
    ...
    public static class Order extends AppCompatActivity {
            ...
            order_btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (number.getText().toString().isEmpty()){
                        Toast.makeText(com.example.projectmilestone.Order.this, "Please enter 919 number", Toast.LENGTH_SHORT).show();
                    }
                    else{
                        dbHelper.insert(type,price,toppings);
                        Toast.makeText(com.example.projectmilestone.Order.this, "Order created successfully", Toast.LENGTH_SHORT).show();
                        startActivity(i);
                    }
